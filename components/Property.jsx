...
const Property = ({ property: { coverPhoto, price, rentFrequency, rooms, title, baths, area, agency, isVerified, externalID  } }) => (
    <Link href={`/property/${externalID}`} passHref>
        <Flex flexWrap = "wrap" w = "420px" p = "0" paddingTop= "0" justifyContent= "flex-start" cursor = "pointer">
            <Box>
            ...
            <Box w ="full">
                ...
                <Flex alignItems="center" p ="1" justifyContent= "space-between" w ="250px" color = "darkgreen.500"> {rooms} <FaBed /> | {baths} <FaBath/> | {millify(area)} sqft <BsGridFill/>
                </Flex>
                <Text fontSize= "lg">
